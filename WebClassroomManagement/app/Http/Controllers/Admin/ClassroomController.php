...
class ClassroomController extends Controller
{
    ...
    public function acalendar($room)
    {
        return view('admin.classroom.acalendar', ['room' => $room]);
    }
    public function close($room)
    {
        return view('admin.classroom.close', ['room' => $room]);
    }
    ...
    {
        return  view('admin.classroom.confirm');
    }
    public function ts()
    {
        return  view('admin.classroom.ts');
    }
