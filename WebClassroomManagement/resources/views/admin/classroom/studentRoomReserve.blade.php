                        ...
                        <div class="card">
                            <div class="container">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                            <tr>
                                                <th><a href="{{ route('admin.classroom.list.student_room.info.time', [$room, "9.00-12.00"]) }}">9.00-12.00</a></th>
                                                <th>available</th>
                                            ...
                                            <tr>
                                                <th><a href="{{ route('admin.classroom.list.student_room.info.time', [$room, "13.00-16.00"]) }}">13.00-16.00</a></th>
                                                <th>unavailable</th>
                                                <th><a href="{{ route('admin.classroom.list') }}" class="btn btn-info" role="button">Reserve</a></th>
                                                <th><a href="{{ route('admin.classroom.list') }}" class="btn btn-info" role="button">Edit</a></th>
                                            </tr>
                                            <tr>
                                                <th><a href="{{ route('admin.classroom.list.student_room.info.time', [$room, "16.30-19.30"]) }}">16.30-19.30</a></th>
                                                <th>available</th>
                                                <th><a href="{{ route('admin.classroom.list') }}" class="btn btn-info" role="button">Reserve</a></th>
                                                <th><a href="{{ route('admin.classroom.list') }}" class="btn btn-info" role="button">Edit</a></th>
                                            </tr>
