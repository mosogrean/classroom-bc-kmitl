                        ...
                        <div class="card">
                            <div class="container">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th><a href="{{ route('admin.classroom.list.student_room.info', "HM304") }}">HM304</a></th>
                                        <th>อาคาร7ชั้น ชั้น3 คณะวิศวกรรมศาสตร์ KMITL</th>
                                    </tr>
                                    <tr>
                                        <th><a href="{{ route('admin.classroom.list.student_room.info', "E303") }}">E303</a></th>
                                        <th>อาคาร12ชั้น ชั้น3 คณะวิศวกรรมศาสตร์ KMITL</th>
                                    </tr>
                                    <tr>
                                        <th><a href="{{ route('admin.classroom.list.student_room.info', "D513") }}">D513</a></th>
