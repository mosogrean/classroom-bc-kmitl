...
@section('content')
    ...
    <div class="panel panel-default articles">
        ...
        <div class="panel-body articles-container">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table class="col-lg-6 table" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <h4><a href="{{ route('admin.tid.troom',$id) }}">This user has reserved 1 room.</a></h4>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">Class in hand   :</td>
                                            <td align="left">
                                                <h4><a href="{{ route('admin.tid.troom',$id) }}">This user has 0 class in hand.</a></h4>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
            ...
            <a href="{{ route('admin.tid',$id) }}" class="btn btn-default btn-md pull-right" role="button">Cancel</a>
            <a href="{{ route('admin.tid',$id) }}" class="btn btn-default btn-md pull-right" role="button" style="background:#8AD919">Save</a>
        </div>
    </div>
            @endsection
