...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Student user room</h1>
        </div>
    </div>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-xs-9 col-md-9">
                            <h4><li><a href='{{ route('admin.sid.opensroom',$id)}}'>HM-303</a></li></h4>
                            <h>Date: 25-01-2019</h>
                            <h>Address: อาคาร7ชั้น ชั้น3 คณะวิศวกรรมศาสตร์</h>
                            <a href="{{ route('admin.sid.unreserves',$id) }}" class="btn btn-default btn-md pull-right" role="button">Unreserve</a>
