...
@section('content')
    ...
    <div class="panel panel-default articles">
        ...
        <div class="col-xs-12">
            ...
            <a href="{{ route('teacher.profile') }}" class="btn btn-default btn-md pull-right" role="button">Cancel</a>
            <a href="{{ route('teacher.profile') }}" class="btn btn-default btn-md pull-right" role="button" style="background:#8AD919">Save</a>
        </div>
    </div>
            @endsection
