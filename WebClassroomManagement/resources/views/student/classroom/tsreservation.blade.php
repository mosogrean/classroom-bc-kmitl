            ...
            <div class="panel-body">
                <form action="{{route('student.tsconfirmation')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div align="right">
                                <input type="submit" class="btn btn-md btn-confirm btn-align:center" style="background:#8AD919" value="Confirm">
                                <input type="submit" class="btn btn-md btn-danger" formaction="{{route('student.classroom.teacherAndStudent')}}" formmethod="get" value="Cancel">
